...
public class EstimacionDtoResponse {
    ...
    public EstimacionDtoResponse(Long planId, Long tareaId, Long creadorId, double cantidad, TipoEstimacion tipoEstimacion, MonedasDisponibles tipoMoneda, String descripcion, Long pagadorId, Long gastoId) {
        this.planId = planId;
